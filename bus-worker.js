...
async function getFileContent (fileName) {
	// Probably only works for json or har files.
	// If JS/MJS, replace declaration? E.g., "export default ...".replace(/^[A-z0-9\s]+/, "")
	// Results should be parsable json unless user error.
